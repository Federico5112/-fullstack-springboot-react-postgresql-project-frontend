...
function Post(props) {
    ...
    const checkLikes = () => {
        const likeControl = likes?.find((like) => like.userId === parseInt(localStorage.getItem("currentUser")));
        if (likeControl != null) {
            ...
            <Card sx={{ width: 800, textAlign: "left", margin: 2.5 }}>
                ...
                <Collapse in={expanded} timeout="auto" unmountOnExit>
                    <CardContent>
                        ...
                        {disabled ? "" :
                            <CommentForm postId={postId} setCommentRefresh={setCommentRefresh}></CommentForm>}
                    </CardContent>
                </Collapse>
            </Card>
        </div>
